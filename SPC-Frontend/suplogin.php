...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $ch = curl_init();
    $url = "http://localhost:5268/api/Supplier/SupplierLogin";
...
<body>
    <div class="login-container">
        ...
        <div class="login-footer">
            <p>Don't have an account? <a href="supregisters.php">Register Now</a></p>
            <p style="margin-top: 1rem;">Need help? <a href="contact.html">Contact Support</a></p>
        </div>
    </div>
</body>
</html>
